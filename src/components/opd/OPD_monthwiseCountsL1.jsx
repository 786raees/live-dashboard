...
class Chart extends Component {
  ...
  componentDidMount() {
    LiveDashboardServices.getmonthwiseOPDCountsL1().then((res) => {
      var labels = [];
  ...
  render() {
    ...
    return (
      <Card className="card" border="info" style={{ marginLeft: '180px', marginRight: '100px' }}>
        <div className="App">
          <h2 style={{ color: 'white', textAlign: 'center', background: 'blue' }}>Month wise OPD Visits for the Specified Period</h2>
          <Bar height="120px"
