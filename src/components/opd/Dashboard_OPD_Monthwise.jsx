...
export default class Dashboard_OPD_datewiseCountsL1 extends Component {
  ...
  componentDidMount() {
    LiveDashboardServices.getmonthewiseOPDCounts().then((res) => {
      var labels = [];
    ...
    return (
      <div>
        <Card style={{ borderColor: 'red', }}>
          <h5 style={{ color: 'white', textAlign: 'center', background: 'red' }}>Month wis OPD Visits for the defined Period</h5>
          <div>
            <Line height="125px"
