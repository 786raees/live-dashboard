...
export default class Dashboard_Radiology_Datewise extends Component {
  constructor(props) {
    super(props);
    this.state = {
      chartData: {
    ...
    return (
      <div>
        <Card style={{ borderColor: "red" }}>
          <div className="text-center rounded-t-xl bg-pink-700 text-white p-3 border-b-4 border-pink-900">
            <h4 className="text-3xl">
              Date wis No of Radiology Tests for the Last 30 Days
            </h4>
          </div>
