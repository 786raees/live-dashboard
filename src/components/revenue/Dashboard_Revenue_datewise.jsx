...
export default class Dashboard_Revenue_datewise extends Component {
  constructor(props) {
    super(props);
    this.state = {
      chartData: {
  ...
  componentDidMount() {
    LiveDashboardServices.getLast30DaysRevenueL1().then((res) => {
      var labels = [];
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="text-center rounded-t-xl bg-yellow-700 text-white p-3 border-b-4 border-yellow-900">
            <h4 className="text-3xl">
            Date wise Revenue in Million for the Last 30 Days
            </h4>
          </div>
