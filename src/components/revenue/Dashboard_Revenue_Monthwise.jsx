...
export default class Dashboard_Revenue_Monthwise extends Component {
  constructor(props) {
    super(props);
    this.state = {
      chartData: {
    ...
    return (
      <div>
        <Card style={{ borderColor: 'red', }}>
          <h5 style={{ color: 'white', textAlign: 'center', background: '#808000' }}>Month wise Revenue in Million for the defined period</h5>
          <div>
            <Line height="110px"
