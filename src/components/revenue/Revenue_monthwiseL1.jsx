...
export default class Revenue_monthwiseL1 extends Component {
  ...
  componentDidMount() {
    LiveDashboardServices.getmonthwiseRevenueL1().then((res) => {
      var labels = [];
  ...
  render() {
    ...
    return (
      <Card className="card" border="info" style={{ marginLeft: '180px', marginRight: '100px', marginBottom: '100px' }}>
        <div className="App">
          <h2 style={{ color: 'white', textAlign: 'center', background: 'blue' }}>Month wise Revenue in Million for the defined period</h2>
          <Bar height="120px"
