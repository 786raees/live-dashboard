...
export default class Dashboard_Revenue_Specialitywise extends Component {
  constructor(props) {
    super(props);
    this.state = {
      chartData: {
  ...
  componentDidMount() {
    LiveDashboardServices.getSpecialitywiseRevenueL1().then((res) => {
      var labels = [];
    ...
    return (
      <div>
        <Card style={{ borderColor: 'red', }}>
          <h3 style={{ color: 'white', textAlign: 'center', background: '#808000' }}>Revenue --Speciality wise in Million for the defined period</h3>
          <div>
            <Line height="80px"
