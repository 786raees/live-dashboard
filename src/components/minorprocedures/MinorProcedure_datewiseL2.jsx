...
export default class MajorProcedure_datewisel1 extends Component{
  ...
  this.ViewMinProcL3 = this.ViewMinProcL3.bind(this);    
}

componentDidMount(){
    LiveDashboardServices.getdatewiseMinProcL2(this.props.location.state.month_name).then((res) => {      
      var labels = [];
  ...
  getElementAtEvent = element => {
    ...
    }, () => this.ViewMinProcL3(this.state.clickedElement, this.props.location.state.month_name, this.props.location.state.date_name));
  }

  ViewMinProcL3(date_name,month_name) {
    this.props.history.push({
      pathname: '/MinorProcL3',
  ...
  render(){    
    ...
    return (      
      ...
      <div className="App">
      <h2 style={{ color: 'white', textAlign: 'center', background: 'blue' }}>Date wise Minor Procedures for the Month of <p style={{ color: 'yellow' }}> {this.props.location.state.month_name} </p> </h2>
       <Bar height ="100px"
