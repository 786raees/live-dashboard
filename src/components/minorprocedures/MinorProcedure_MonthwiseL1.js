...
export default class MajorProcedure_datewisel1 extends Component{
    ...
    this.state = {
      chartData: {        
        ...
        datasets: [
          ...
          {
            // you can have more than one array of data
            label: "PMC Requirement for the Minor Procedures",            
            data: '',            
  ...
  this.ViewMinProcL2 = this.ViewMinProcL2.bind(this);    
}

componentDidMount(){
    LiveDashboardServices.getMonthwiseMinProcL1().then((res) => {      
      var labels = [];
  ...
  getElementAtEvent = element => {
    ...
    }, () => this.ViewMinProcL2(this.state.clickedElement,this.state.month_name) );                
  }

  
  ViewMinProcL2(month_name){
    this.props.history.push({
      pathname: '/MinorProcL2',
  ...
  render(){    
    ...
    return (      
      ...
      <div className="App">
      <h2 style={{ color: 'white', textAlign: 'center', background: 'blue' }}>Month wise Minor Procedures for the defined period</h2>
      <Bar height ="100px"
