...
export default class Dashboard_IPDAdmissions_Specialitywise extends Component{ 
  constructor(props){
    super(props);
    this.state = {
      chartData: {        
  ...
  componentDidMount(){
    LiveDashboardServices.getSpecialitywiseIpdAdmissionsL1().then((res) => {      
      var labels = [];
  ...
  render() {
    ...
    return (    
     ...
     <Card style={{borderColor: 'red', }}>
      <h3 style={{ color: 'white', textAlign: 'center', background: '#FF4500'  }}>IPD Admissions -- Speciality wise for the defined period</h3>
      <div>
        <Line height ="80px"
