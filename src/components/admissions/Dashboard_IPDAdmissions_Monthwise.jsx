...
export default class Dashboard_IPDAdmissions_Monthwise extends Component{ 
  constructor(props){
    super(props);
    this.state = {
      chartData: {        
  ...
  render() {
    ...
    return (    
     ...
     <Card style={{borderColor: 'red', }}>
      <h5 style={{ color: 'white', textAlign: 'center', background: '#FF4500'  }}>Month wise Admissions for the defined period</h5>
      <div>
        <Line height ="110px"
