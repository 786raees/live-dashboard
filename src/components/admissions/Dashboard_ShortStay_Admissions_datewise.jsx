...
export default class Dashboard_ShortStay_Admissions_datewiseL1 extends Component{ 
  constructor(props){
    super(props);
    this.state = {
      chartData: {        
  ...
  render() {
    ...
    return (    
     ...
     <Card style={{borderColor: 'red', }}>
      <h5 style={{ color: 'white', textAlign: 'center', background: '#800000'  }}>Date wise Short Stay for the Last 30 Days</h5>
      <div>
        <Line height ="110px"
