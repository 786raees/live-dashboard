...
import ProcDashboardServices from '../services/LiveDashboardServices';
import {
  Card
} from '@material-ui/core';


export default class Dashboard_CombinedProcedure_Specialitywise extends Component{ 
  constructor(props){
    super(props);
    this.state = {
      chartData: {        
        ...
        datasets: [
          {
            label: 'No Of Combined Procedures',            
            data: '',            
            fill: false,
            lineTension: 0.75,
            backgroundColor: "rgba(225,0,0,0.4)",
            borderColor: "#FF007F", // The main line color
            ...
            spanGaps: true,
              ...
              label: "PMC Combined Requirement",
              fill: false,
              lineTension: 0.75,
              backgroundColor: "red",
              borderColor: "black",
  ...
  componentDidMount(){ProcDashboardServices.getspecialityCombinedProceduresCounts().then((res) => {      
      var labels = [];
  ...
  render() {
    ...
    return (    
     ...
     <Card style={{borderColor: 'red', }}>
      <h3 style={{ color: 'white', textAlign: 'center', background: '#FF007F'  }}> Combined Procedures (Major & Minor) -- Speciality wise for the defined period</h3>
      <div>
        <Line height ="80px"
