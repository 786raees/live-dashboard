...
export default class Dashboard_MajorProcedure_datewise extends Component {
  constructor(props) {
    super(props);
    this.state = {
      chartData: {
  ...
  componentDidMount(){
    LiveDashboardServices.getLast30DaysMajProcL1().then((res) => {
      var labels = [];
        ...
        <Card style={{ borderColor: "red" }}>
          <div className="text-center rounded-t-xl bg-purple-700 text-white p-3 border-b-4 border-purple-900">
            <h4 className="text-3xl">
              Date wise Major Procedures for the Last 30 Days
            </h4>
          </div>
