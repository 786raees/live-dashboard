...
export default class Dashboard_MajorProcedure_Monthwise extends Component{ 
  ...
  componentDidMount(){
    LiveDashboardServices.getmonthwiseMajProcL1().then((res) => {      
      var labels = [];
  ...
  render() {
    ...
    return (    
     ...
     <Card style={{borderColor: 'red', }}>
      <h5 style={{ color: 'white', textAlign: 'center', background: '#FF007F'  }}>Month wise Major Procedures for the defined period</h5>
      <div>
        <Line height ="110px"
