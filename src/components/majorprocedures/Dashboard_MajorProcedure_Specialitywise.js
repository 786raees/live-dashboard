...
export default class Dashboard_MajorProcedure_Monthwise extends Component{ 
  constructor(props){
    super(props);
    this.state = {
      chartData: {        
  ...
  componentDidMount(){
    LiveDashboardServices.getSpecialitywiseMajProcL1().then((res) => {      
      var labels = [];
  ...
  render() {
    ...
    return (    
     ...
     <Card style={{borderColor: 'red', }}>
      <h3 style={{ color: 'white', textAlign: 'center', background: '#FF007F'  }}>Major Procedures -- Speciality wise for the defined period</h3>
      <div>
        <Line height ="80px"
