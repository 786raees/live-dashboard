...
class Chart extends Component{
  constructor(props){
    ...
    this.ViewOccupancyL3 = this.ViewOccupancyL3.bind(this);    
  }

  componentDidMount(){LiveDashboardServices.getdatewisebedOccupancyL2(this.props.location.state.month_name).then((res) => {      
      var labels = [];
  ...
  getElementAtEvent = element => {
    ...
    }, () => this.ViewOccupancyL3(this.state.clickedElement, this.props.location.state.month_name, this.props.location.state.date_name));
  }


  ViewOccupancyL3(date_name,month_name) {
    this.props.history.push({
      pathname: '/OccupancyL3',
  ...
  render(){    
    ...
    return (      
      ...
      <div className="App">
      <h2 style={{ color: 'white', textAlign: 'center', background: 'blue' }}>Date wise Bed Occupancy % in Million for the Month of <p style={{ color: 'yellow' }}> {this.props.location.state.month_name} </p> </h2>
        <Bar height="120px"
