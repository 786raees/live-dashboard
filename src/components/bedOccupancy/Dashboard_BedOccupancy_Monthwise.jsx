...
export default class Dashboard_OPD_datewiseCountsL1 extends Component{ 
  ...
  componentDidMount(){
    LiveDashboardServices.getMonthwisebedOccupancy().then((res) => {      
      var labels = [];
  ...
  render() {
    ...
    return (    
     ...
     <Card style={{borderColor: 'red', }}>
      <h5 style={{ color: 'white', textAlign: 'center', background: '#C71585'  }}>Month wise Bed Occupancy % for the defined period</h5>
      <div>
        <Line height ="125px"
