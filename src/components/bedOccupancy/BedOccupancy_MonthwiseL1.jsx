...
class Chart extends Component{
  constructor(props){
    ...
    this.ViewOccupancyL2 = this.ViewOccupancyL2.bind(this);    
  }

  componentDidMount(){LiveDashboardServices.getMonthwisebedOccupancyL1().then((res) => {      
      var labels = [];
  ...
  getElementAtEvent = element => {
    ...
    }, () => this.ViewOccupancyL2(this.state.clickedElement,this.state.month_name) );                
  }

  
  ViewOccupancyL2(month_name){
    this.props.history.push({
      pathname: '/OccupancyL2',
  ...
  render(){    
    ...
    return (      
      ...
      <div className="App">
          <h2 style={{ color: 'white', textAlign: 'center', background: 'blue'  }}>Date wise Bed Occupancy for the Current Month</h2>
        <Bar height="120px"
